...
import io.github.legion2.open_cue_mqtt.model.Profile
import io.github.legion2.open_cue_mqtt.model.SdkDetails
...
class CueSdkHttpServer(private val host: String = "localhost", private val port: Int = 25555) {
    ...
    suspend fun currentGame(): String = client.get(url("api/sdk/game")).body()
